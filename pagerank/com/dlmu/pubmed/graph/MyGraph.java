...
public class MyGraph implements Serializable {
	public  Graph<MyNode, MyLink> g = new SparseMultigraph<MyNode, MyLink>();
	public String nodePath="";
	public String edgePath="";
	public String graphPath="";
	
	public MyGraph(String nodePath, String edgePath, String graphPath) {
		super();
...
//		MyGraph myPaperGraph = new MyGraph("./output/paperPageRank/pubmed_id.csv","./output/paperPageRank/only pubmedcentral/citation_new.csv","./output/paperPageRank/ppGraph.ser");
//		myPaperGraph.generateGraph();
		
		MyGraph myVolumeGraph = new MyGraph("./output/volumePageRank/volume_id.csv",
				"./output/volumePageRank/pubmed_volumeCiteVolume",
				"./output/volumePageRank/vvGraph.ser");
		myVolumeGraph.generateGraph();
	}
	public void generateGraph() throws Exception
	{
		System.out.println("loading Nodes file......");
		loadingNodes(nodePath);
		System.out.println("loading Edges file......");
		loadingEdges( edgePath);

		try {
			FileOutputStream fs = new FileOutputStream(graphPath);
	...
	public void loadingEdges(String path_loading_name) throws Exception {
		try {
...
//						MyLink edge = new MyLink(i, 0);
						MyLink edge = new MyLink(i, Double.valueOf(linestring[4]));
	...
	public void loadingNodes(String path_loading_name) throws Exception {
